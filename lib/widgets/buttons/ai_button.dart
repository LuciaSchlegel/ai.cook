...
class AiButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use parent container size instead of calculating here
    // This allows the NavBarBuilder to control the size consistently
    final borderWidth = ResponsiveUtils.spacing(context, ResponsiveSpacing.xxs);
          ...
          child: CustomPaint(
            ...
            child: Center(
              child: AnimatedRotation(
                turns: isActive ? 0.25 : 0.0, // 0.25 turns = 90 degrees
                duration: const Duration(milliseconds: 250),
                curve: Curves.easeOut,
                child: FractionallySizedBox(
                  widthFactor: 0.56, // Proportional sizing
                  heightFactor: 0.56,
                  child: Image.asset(
                    'assets/icons/ai.png',
