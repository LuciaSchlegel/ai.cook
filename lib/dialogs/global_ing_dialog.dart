...
Future<void> showGlobalIngredientsDialog(BuildContext context) async {
  ...
  await ingredientsProvider.fetchIngredients(); // global ingredients
  await resourceProvider.getUnits();
  await resourceProvider.getCategories();
  await resourceProvider.getTags();
