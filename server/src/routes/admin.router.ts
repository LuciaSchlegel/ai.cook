...
import { setAdminRoleController, seedResourcesController, seedIngredientsController, seedRecipesController, seedRecipesFromJsonController } from "../controllers/admin.controller";
...
adminRouter.post("/seed/recipes-from-json", seedRecipesFromJsonController as RequestHandler);
